...
const TABS = [
    ...
    {
        id: "hod",
        label: "HOD / Designee Review (Engineering Dept)",
    },
    {
        id: "user-dept-review",
        label: "User Department Review (User Dept)",
    },
    {
        id: "qa-review",
        label: "QA Approval Review",
    },
];
...
const buildProcessData = (
...

    {
        ...
        label:
            "HOD / Designee Review Comments",
        value:
            values?.hodReviewComments ||
            "",
    },
...

    {
        ...
        label:
            "User Dept Review Comments",
        value:
            values?.userDeptReviewComments ||
            "",
    },

    {
        ...
        label:
            "User Dept Review Attachment",
        value:
            values?.userDeptReviewAttachment ||
            [],
    },
...
const CreateCalibration = () => {
    ...
    const [initiator, setInitiator] =
        useState("");

    const [initiatorId, setInitiatorId] =
        useState("");
    ...
    const [recordNumber, setRecordNumber] =
        useState("");
    ...
    return (
        ...
        >
            ...
            <Form
                ...
                className="
                    w-full
                    [&_.ant-form-item-label>label]:!text-[11px]
                    [&_.ant-form-item-label>label]:!font-semibold
                    [&_.ant-form-item-label]:!pb-1
                    [&_.ant-form-item-explain-error]:!text-[10px]
                "
            >
                {/* =================================================
                    GENERAL INFORMATION
