...
import { Activity, Wrench, Hash, Factory, Cpu, Layers3 } from "lucide-react";
  ...
  const handleSubmit = async (values) => {
    ...
    const checklistConfig = categories
      ...
      .map((cat) => ({
        ...
        checkpoints: cat.checkpoints.map((cp) => cp.text.trim()).filter((t) => t !== ""),
      }))
  ...
  return (
    <div className="min-h-full w-full bg-[var(--color-background)] px-4 pb-12 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-7xl">
        ...
        <section className="overflow-hidden rounded-[18px] border border-[var(--color-border)] bg-[var(--color-surface)] shadow-[0_5px_20px_rgba(36,50,56,0.055)]">
          ...
          <div className="px-5 pb-5 pt-4 sm:px-6 sm:pb-6">
            <Form
              ...
              className="w-full [&_.ant-form-item-label>label]:!text-[10.5px] [&_.ant-form-item-label>label]:!font-bold [&_.ant-form-item-label>label]:!uppercase [&_.ant-form-item-label>label]:!tracking-[0.07em] [&_.ant-form-item-label]:!pb-1.5 [&_.ant-form-item-explain-error]:!text-[10.5px] [&_.ant-form-item-required::before]:!text-[#B54A4A] [&_.ant-input]:!rounded-[10px]"
            >
              <div className="grid grid-cols-1 gap-x-6 md:grid-cols-2">
                ...
                <Form.Item
                  ...
                  label={
                    <span className="flex items-center gap-1.5">
                      <Wrench size={12} strokeWidth={1.9} className="text-[#56766D]" />
                      Equipment Name
                    </span>
                  }
                ...
                <Form.Item
                  ...
                  label={
                    <span className="flex items-center gap-1.5">
                      <Hash size={12} strokeWidth={1.9} className="text-[#56766D]" />
                      Equipment ID
                    </span>
                  }
                ...
                <Form.Item
                  ...
                  label={
                    <span className="flex items-center gap-1.5">
                      <Factory size={12} strokeWidth={1.9} className="text-[#56766D]" />
                      Make
                    </span>
                  }
                ...
                <Form.Item
                  ...
                  label={
                    <span className="flex items-center gap-1.5">
                      <Cpu size={12} strokeWidth={1.9} className="text-[#56766D]" />
                      Model
                    </span>
                  }
                ...
                <Form.Item
                  ...
                  label={
                    <span className="flex items-center gap-1.5">
                      <Layers3 size={12} strokeWidth={1.9} className="text-[#56766D]" />
                      Equipment Type
                    </span>
                  }
        ...
        ====================================================== */}
        <section className="mt-5 overflow-hidden rounded-[18px] border border-[var(--color-border)] bg-[var(--color-surface)] shadow-[0_5px_20px_rgba(36,50,56,0.055)]">
