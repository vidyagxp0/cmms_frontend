...
const ProcessPage = () => {
    ...
    const createRecordFrom = location.state?.from || "engineering";
    ...
    try {
        ...
        let filteredProcesses = Array.isArray(processData)
            ? processData.filter((process) => process.is_active)
            : [];

        if (createRecordFrom === "equipment") {
            filteredProcesses = filteredProcesses.filter(
                (process) => process.id === 3
            );
        } else {
            filteredProcesses = filteredProcesses.filter(
                (process) => process.is_child === false
            );
        }
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <span className="min-w-0 flex-1">
                                                            ...
                                                            {/* <span className="mt-0.5 block text-[9.5px] text-[#98A19D]">
                                                                {process.is_child
                                                                    ? "Process"
                                                                    : "Planner & management"}
                                                            </span> */}
